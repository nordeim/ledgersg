...
class AccountListCreateView(APIView):
    ...
    def get(self, request, org_id: str) -> Response:
        ...
        serializer = AccountListSerializer(
            accounts, many=True, context={"include_balance": include_balance}
        )
    ...
    def post(self, request, org_id: str) -> Response:
        ...
        # Create account
        account = AccountService.create_account(org_id=org_id, **serializer.validated_data)
...
class AccountDetailView(APIView):
    ...
    def patch(self, request, org_id: str, account_id: str) -> Response:
        ...
        account = AccountService.update_account(
            org_id=org_id, account_id=account_id, **serializer.validated_data
        )
...
class TrialBalanceView(APIView):
    ...
    def get(self, request, org_id: str) -> Response:
        ...
        trial_balance = AccountService.get_trial_balance(org_id, fiscal_year_id=fiscal_year_id)
